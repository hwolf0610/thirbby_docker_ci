                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a class="btn default btn-sm green-btn" href="<?php echo base_url().ADMIN_URL.'/'.$this->controller_name;?>/add"><i class="fa fa-plus"></i> Add</a>
                            </div>
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-sm red filter-cancel red-btn"><i class="fa fa-times"></i> Reset</button>
                                        </td>
                                    </tr>
                                    </thead>                                        
                                    <tbody>
