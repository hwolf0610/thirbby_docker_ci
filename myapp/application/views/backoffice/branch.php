                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a class="btn danger-btn btn-sm green-btn" href="<?php echo base_url().ADMIN_URL;?>/branch/add"><i class="fa fa-plus"></i> Add</a>
                            </div>
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                        ...
                                        <tr role="row" class="filter">
                                            ...
                                            <td><div class="margin-bottom-5">
                                                    <button class="btn btn-sm  danger-btn filter-submit margin-bottom red-btn"><i class="fa fa-search"></i> Search</button>
                                                </div>
